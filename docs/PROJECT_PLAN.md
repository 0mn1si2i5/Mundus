...
- 状态：阶段 4 已完成，正在完成 V1 产品循环后进入开源发布
- 更新日期：2026-07-15
- 内部项目名：Mundus
...
- 展示双方坐标、国家或海洋、最近人口聚居地、地心直线距离和半球表面距离。
- 提供精选示例，帮助用户在十秒内理解模式。
...
- Natural Earth 110m 用作首屏轮廓，50m 边界和 populated places 按模式懒加载。
- 构建阶段转为简化 TopoJSON，并生成轻量搜索索引和边界元数据。
...
- 首屏压缩资源不超过约 1.2 MB，其余模式和 50m 数据懒加载。
