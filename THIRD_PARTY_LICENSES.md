...
| Wikidata Historical Echoes      | Wikidata dump 2026-08-10          | [CC0 1.0](https://creativecommons.org/publicdomain/zero/1.0/) | Contains data from Wikidata, transformed by Mundus                                                 |
...
The redistributed Historical Echoes artifact is a filtered transformation of
the pinned Wikidata entity dump. Wikidata makes structured data available under
the CC0 public domain dedication; source identity and transformations are
recorded in `DATA_SOURCES.md` and the corresponding data manifest.
