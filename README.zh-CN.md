...
- **地球另一端（Other Side）**：计算对跖点，并识别其国家、海洋以及 Natural Earth 精选数据中最近的聚居地。
...
经过验证的线上站点为 <https://0mn1si2i5.github.io/Mundus/>。GitHub Pages 从经过审阅的 `main` 构建，并在每次生产部署后完成桌面与移动端检查。
